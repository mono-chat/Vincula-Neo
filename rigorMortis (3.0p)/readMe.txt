/* 
    ...
    version     - 3.0p
    author      - sid
    description - mirc-msn client chat script
    date        - 12/02/2004 / 02/03/04

    tested OS   - XP
    tested CPU  - AMD Athlon 2400+ XP pro
    tested RAM  - 768 PC2100 DDR
    tested mIRC - 6.12
    ...
    information - This is a follow on from my last connection "Mortis". I was inspired to write
		...
		- I've changed the connection around because of the newest MSN chat network
		  updated. They only have server's CHAT 1-3 now. This is good news as it meens
		  less sockets to leave idle.
		- Updated a few more bits and bobs.
		- Last version of this connection, will no longer be releaseing my code.
    ...
    plans       - I made a mass joiner for this, but i scrapped it because it was too fast and  
                  mIRC couldn't cope with it. It ended up where the boolean expression 
                  "JOIN == JOIN" was returning 0, and the sockets would not rename. I plan to  
                  make a new one for the next version, though.
                - Find a way to talk without propping subinfo.
                - Figure the ocx's algorithm for encoding auth's.
                - To add a recreation bot.
